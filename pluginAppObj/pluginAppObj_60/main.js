...
function fontAwesomeIcons_pluginAppObj_60() {
    ...
    function getClassIcon(){   
        ...
        switch("web_application_icons") {
            ...
            case "directional_icons":
                 fileName = "hand-o-left.png"; 
                break;
            case "video_player_icons":
                 fileName = ""; 
                break;
            case "brand_icons":
                 fileName = "angellist.png"; 
                break;
            case "medical_icons":
                 fileName = ""; 
                break;
    ...
    $(document).ready(function(){
        ...
        var link = $(".pluginAppObj_60_child");
        var icon = $("#pluginAppObj_60_icon");
